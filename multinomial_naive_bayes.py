...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun 12 19:45:16 2018
...
print("multinomial_naive_bayes AUC: {0}".format(metrics.auc(fpr, tpr)))
...
df.to_csv("./naive_bayes_predictions.csv",sep=',',index=False)